...
class SyncHitachiDataBk extends Command
{

    protected function configure()
    {
        $this->setName('SyncHitachiDataBk')->setDescription('this api is for SyncHitachiData')
    ...
    {
        $absolutePath = 'D:\PHP\allProjectFile\tinengProject\datacenterFile\ahtks\7100\123\/';
...
//                    continue;
                    $all_staff_info[$staff_name]['department_uuid'] = null;
                    $all_staff_info[$staff_name]['uuid'] = null;
                }
                foreach ($item as $k => $v){
                    if(empty($v)){
                        $item[$k] = '';
