...
if (!function_exists('json')) {
    ...
    {
        $trace_id = \think\App::$trace_id;
        $data['trace_id'] = $trace_id;
        //错误反馈id
        if (!empty($data['code']) && $data['code'] == 2) {
            log::write(json_encode($data,JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), 'exception');
        }
        return Response::create(unserialize(str_replace(array('NAN;','INF;'),'0;',serialize($data))), 'json', $code, $header, $options);
    }
}
